...
const testObject: Restaurant = {
    ...
    location: "Hamburger str. 20, Hamburg",
    heroImage: "https://images.pexels.com/photos/262978/pexels-photo-262978.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    detailImagesUrls: [
...
const AddRestaurantForm = () => {
    ...
    const [detailsImage, setDetailsImage] = useState<string>("")
    const [location, setLocation] = useState<string>("")
    const [type, setType] = useState<string>("")
    const [rating, setRating] = useState<string>("1")
    const [detailImagesUrlsState, setDetailImagesUrls] = useState<string[]>([])
    ...
    const handleAddImages = (e: { target: { value: React.SetStateAction<string>; }; }) => {
        ...
        if (detailsImage.trim() !== '') {
            setDetailImagesUrls([...detailImagesUrlsState, detailsImage]); // Add new item to the beginning of the array
        }
    }
    ...
    return (
        <form method="POST" onSubmit={handleSubmit}>
            <div className="mt-20 space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-600">
                        Your favourite restaurant - you want to share it with the world. You can do it here.
                        Add details of the restaurant below and save it for others to see it.
                    </p>
                ...
                />
                            ...
                            <p className="mt-3 text-sm leading-6 text-gray-600">Write as many details about
                                the restaurant as possible.</p>
                        </div>
                            ...
                            <div className="mt-2">
                                <div
                                    ...
                                    <input
                                        ...
                                        className="block flex-1 border-0 bg-transparent py-1.5 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                        placeholder="Upload Restaurant Hero Image"
                                    />
                                </div>
                            </div>
                            <div
                            ...
                            <div className="mt-2">
                                <div
                                    ...
                                    <input
                                        ...
                                        className="block flex-1 border-0 bg-transparent py-1.5 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                        placeholder="Upload Restaurant Details Page Image"
                                    />
                                </div>
                            </div>
                            <div
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-base font-semibold leading-7 text-gray-900">Restaurant Details</h2>
                    <p className="mt-1 text-sm leading-6 text-gray-600">Share more information about the location and
                        type of the restaurant.</p>
            ...
            <div className="mt-6 pb-6 flex justify-center items-center gap-x-6">
