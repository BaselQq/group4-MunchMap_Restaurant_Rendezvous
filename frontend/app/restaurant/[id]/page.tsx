...
const RestaurantDetails = ({ params }: { params: { id: string } }) => {
    ...
    const { name, description, rating, location, favourite, heroImageUrl } = data || { name: '', description: '', rating: 1, location: '', favourite: false };
                ...
                <div className="flex flex-col md:flex-row -mx-4">
                    <div className="md:flex-1 px-4">
                        <div className="h-[460px] rounded-lg bg-gray-300 dark:bg-gray-700 mb-4">
                            <img className="w-full h-full object-cover" src={heroImageUrl} alt="Restaurant Image" />
                        </div>
                    ...
                    <div className="md:flex-1 px-4">
                        ...
                        <div className="flex mb-4">
                            ...
                            <div>
                                ...
                                <span className="text-gray-600 dark:text-gray-300">Until 21:00</span>
                            </div>
                        </div>
                        <div className="mb-4">
